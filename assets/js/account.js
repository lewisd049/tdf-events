...
async function showAccount(
  ...
  /*
   * Upcoming and live registrations.
   */
  const upcoming =
    enriched
      .filter(
   ...
   * IMPORTANT:
   *
   * Everyone sees their own Past Events.
   *
   * Only admins see the
      ...
      <div class="registration-list">
        ...
        ${
          past.length
            ...
            : `
              <p>
                You have no past event registrations yet.
              </p>
            `
        }
  ...
  return `
    ...
    <div class="registration-row">
      ...
      <div class="registration-actions">
        ...
        <a
          class="small-button"
          href="/event/?id=${encodeURIComponent(
            r.eventId
          )}"
        >
          View
